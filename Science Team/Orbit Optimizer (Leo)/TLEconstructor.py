...
def func (inc, eccen, nodeo):
    ...
    SNIFS = wgs84.latlon(19.82, -155.4694, 4245)
    ...
    obsdf = pd.DataFrame({'Time (EST)': temptime, 
                    ...
                    'SNIFS Alt (Deg)': obstempdf[:, 9, :].flatten(), 'SNIFS Az (Deg)': obstempdf[:, 10, :].flatten(),  'SNIFS TIME': obstempdf[:, 11, :].flatten()})
